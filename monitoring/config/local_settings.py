...
# ]
#
# In both formats, the links have an optional 'raw' attribute which defaults to
# False if unspecified. If it is False, the value of 'path' is interpreted as a
# dashboard name and a link to the dashboard based on the dashboard's found in
# the 'path' will be generated. If it is true, the value of path will be
# treated as a URL to be used verbatim.
#
# If GRAFANA_URL is specified, the dashboard file name/raw URL must be
# specified through the 'path' attribute as shown above. If GRAFANA_URL is
# unspecified it must be specified through the fileName attribute as follows:
#
# Flat:
