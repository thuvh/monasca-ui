...
class BaseAlarmForm(forms.SelfHandlingForm):
    ...
    def _init_fields(self, readOnly=False, create=False, initial=None):
        ...
        self.fields['name'] = forms.CharField(label=_("Name"),
                                              ...
                                              max_length=250,
                                              widget=textWidget,
                                              help_text=_("A unique name of the alarm. "
        ...
        self.fields['match_by'] = forms.CharField(label=_("Match by"),
                                                  ...
                                                  help_text=_("The metric dimensions to use "
        ...
        self.fields['notifications'] = NotificationField(
            ...
            help_text=_("Notification method. "
                        "Notifications can be sent to when an alarm state transition occurs."))
